...
| Command | Does |
|---------|------|
| `remove` (default) | Auto-detect + remove visible watermarks (optionally suppress SynthID) |
| `visible` | Remove only the visible watermark |
| `synthid` | Suppress only the SynthID invisible watermark (heuristic; not a verifiable removal) |
